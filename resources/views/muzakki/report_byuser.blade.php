<table style="border: 1px solid #ddd; width: 100%; border-collapse: collapse; text-align: left;">
   <thead style="background-color: #f8f9fa; border-bottom: 2px solid #ddd;">
      <tr>
         ...
         <th style="border: 1px solid #ddd; padding: 8px; text-align: center;">PETUGAS ZAKAT</th>
   ...
   <tbody>
      ...
      ?>
            <tr>
               ...
               <td rowspan="{{ count($header->details) }}" style="border: 1px solid #ddd; padding: 8px; text-align: center;">
                  {{ $header->createdByUser ? $header->createdByUser->nama_lengkap : 'Tidak Diketahui' }}
               </td>
         ...
         foreach ($totalsByCode as $code => $totals) {
            ...
            ?>
               <tr>
                  <td colspan="6" rowspan="3" style="border: 1px solid #ddd; text-align: center; font-weight: bold; padding: 8px;">{{ $code }}</td>
      ...
      <!--SATUAN KG -->
      <tr>
         <td colspan="6" rowspan="3" style="border: 1px solid #ddd; text-align: center; font-weight: bold; padding: 8px; background-color: #494949; color:#fff ">TOTAL KESELURUHAN</td>
